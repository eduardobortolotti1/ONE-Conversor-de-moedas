...
public class ExchangeRateResponse {
    ...
    private Map<String, Double> conversion_rates; // Map para armazenar as taxas de conversão
    ...
    public double getConversion_rate(String code) {
        return conversion_rates.get(code);
    }
}
